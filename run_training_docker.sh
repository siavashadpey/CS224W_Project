...
export IMAGE_TAG_LOCAL="cs224w-training-deps:latest"

echo "=========================================="
echo "Running Training with LOCAL CODE in Docker"
echo "=========================================="
echo "Local Directory: ${LOCAL_PROJECT_DIR}"
echo "Docker Image: ${IMAGE_TAG_LOCAL}"
...
if [ "${SKIP_BUILD}" = "true" ]; then
    ...
    docker build -t ${IMAGE_TAG_LOCAL} --no-cache .
fi
